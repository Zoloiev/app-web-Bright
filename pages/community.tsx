...
const Community: React.FC<IndexProps> = () => {
        ...
        <div className="w-0 flex-1 px-4 pb-4">
          <div className='py-6'>
            <div className='md:grid md:grid-cols-4'>
              <div className='col-span-4 sm:col-span-2 lg:col-span-3 border-0 border-b-[1px] md:border-r-[1px] md:border-b-0 border-solid border-[#ECE9EC] px-8'>
              ...
              <div className='pl-8 pr-4 col-span-2 lg:col-span-1 sm:block'>
                <div className='mt-8'>
                  <CustomRadio
                    radioItems={[
                      {
